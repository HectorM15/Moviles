...
public class DatabaseInitializer {
    ...
    public void initializer() {
        ...
        arr_questions[0] = new Questions(0, "¿Cuál de las siguientes tiene más neuronas?", false, 2, false);
        arr_questions[1] = new Questions(1, "¿Cuál fue el primer emperador romano de origen hispano?", false, 2, false);
        arr_questions[2] = new Questions(2, "¿Dónde se produce la respiración celular?", false, 2, false);
        arr_questions[3] = new Questions(3, "¿Cuánto mide el Everest?", false, 2, false);
        arr_questions[4] = new Questions(4, "¿De qué continente son originarios los ornitorrincos?", false, 2, false);
        arr_questions[5] = new Questions(5, "¿Cual obra es de Dalí?", false, 2, true);
        arr_questions[6] = new Questions(6, "¿Cual obra es de Piccaso?", false, 2, true);
        arr_questions[7] = new Questions(7, "¿Cual obra es de Van Gogh?", false, 2, true);
        arr_questions[8] = new Questions(8, "¿Cual obra es de Velázquez?", false, 2, true);
        ...
        //PREGUNTA 1
        Answer answer_11 = new Answer(1, 0, "Gato", false);
        Answer answer_12 = new Answer(2, 0, "Banana", false);
        Answer answer_13 = new Answer(3, 0, "Estómago", true);
        Answer answer_14 = new Answer(4, 0, "Brazo", false);

        //PREGUNTA 2
        Answer answer_21 = new Answer(5, 1, "Julio César", false);
        Answer answer_22 = new Answer(6, 1, "Calígula", false);
        Answer answer_23 = new Answer(7, 1, "Trajano", true);
        Answer answer_24 = new Answer(8,1, "Tibero Claudio Cesar", false);

        //PREGUNTA 3
        Answer answer_31 = new Answer(9,2,"Lisosoma",false);
        Answer answer_32 = new Answer(10,2,"Vacuolas",false);
        Answer answer_33 = new Answer(11,2,"Ribosomas",false);
        Answer answer_34 = new Answer(12,2,"Mitocondrias",true);



        //PREGUNTA 4
        Answer answer_41 = new Answer(13,3,"8848 metros",true);
        Answer answer_42 =new Answer(14,3,"8488 metros",false);
        Answer answer_43 = new Answer(15,3,"8884 metros",false);
        Answer answer_44 =new Answer(16,3,"9 kilómetros",false);

        //PREGUNTA 5
        Answer answer_51 = new Answer(17,4,"Australia",true);
        Answer answer_52 = new Answer(18,4,"Europa",false);
        Answer answer_53 =new Answer(19,4,"America",false);
        Answer answer_54 = new Answer(20,4,"Africa",false);

        //PREGUNTA 6
        Answer answer_61 = new Answer(21,5,"Dali",true);
        Answer answer_62 = new Answer(22,5,"VG",false);
        Answer answer_63 = new Answer(23,5,"Velazquez",false);
        Answer answer_64 = new Answer(24,5,"Picasso",false);
        ...
        //PREGUNTA 7
        Answer answer_71 = new Answer(25,6,"Dali",false);
        Answer answer_72 =new Answer(26,6,"VG",false);
        Answer answer_73 = new Answer(27,6,"Velazquez",false);
        Answer answer_74 = new Answer(28,6,"Picasso",true);
        ...
        //PREGUNTA 8
        Answer answer_81 = new Answer(29,7,"Dali",false);
        Answer answer_82 =new Answer(30,7,"VG",true);
        Answer answer_83 = new Answer(31,7,"Velazquez",false);
        Answer answer_84 = new Answer(32,7,"Picasso",false);
        ...
        //PREGUNTA 9
        Answer answer_91 =  new Answer(33,8,"Dali",false);
        Answer answer_92 = new Answer(34,8,"VG",false);
        Answer answer_93 =  new Answer(35,8,"Velazquez",true);
        Answer answer_94 =  new Answer(36,8,"Picasso",false);
